...
describe('sanitizeEnvironment', () => {
  ...
  it('should redact variables with values matching all token and credential patterns', () => {
    const env = {
      // GitHub
      GITHUB_TOKEN_GHP: 'github-placeholder-token-ghp',
      GITHUB_TOKEN_GHO: 'github-placeholder-token-gho',
      GITHUB_TOKEN_GHU: 'github-placeholder-token-ghu',
      GITHUB_TOKEN_GHS: 'github-placeholder-token-ghs',
      GITHUB_TOKEN_GHR: 'github-placeholder-token-ghr',
      GITHUB_PAT: 'github-placeholder-token-pat',
      // Google
      GOOGLE_KEY: 'google-api-key-placeholder',
      // AWS
      AWS_KEY: 'aws-access-key-placeholder',
      // JWT
      JWT_TOKEN: 'jwt-token-placeholder',
      // Stripe
      STRIPE_SK_LIVE: 'stripe-live-secret-placeholder',
      STRIPE_RK_LIVE: 'stripe-live-restricted-placeholder',
      STRIPE_SK_TEST: 'stripe-test-secret-placeholder',
      STRIPE_RK_TEST: 'stripe-test-restricted-placeholder',
      // Slack
      SLACK_XOXB: 'slack-bot-token-placeholder',
      SLACK_XOXA: 'slack-app-token-placeholder',
      SLACK_XOXP: 'slack-user-token-placeholder',
      SLACK_XOXB_2: 'slack-refresh-token-placeholder',
      // URL Credentials
