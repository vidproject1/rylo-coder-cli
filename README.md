...
Rylo Coder CLI is a provider-agnostic fork of Gemini CLI aimed at multi-provider
API support, local-LLM operation, and reduced prompt/context overhead. The
upstream Gemini-specific documentation below is being replaced incrementally as
the fork is bootstrapped.
